...
<Router>
  ...
  <Switch>
    ...
    <Route exact path='/id/:userHandle/setting'  component={Anasayfa}/>
    <Route exact path='/id/BankaBilgi/:ikonId'  component={Anasayfa}/>
    <Route exact path='/id/SosyalIkons/:ikonId'  component={Anasayfa}/>
    <Route exact path='/id/kisiseldata/jfkjsdkfjksdjfkjskjfsfkhhfıhueryfyhshdnvbhvchbhjhxhid=?buradhereconfidentiels'  component={Anasayfa}/>
    <Route exact path='/id/FaturaData/%2Fappengine%2Fquotadetails%3Fauthuser%3D0&project%3Dundefined/permissions?projec?id=?thuser%3D0&project%3Dundefined' component={Anasayfa}/>
    <Route exact path='/id/ContactsIkons/:ikonId'  component={Anasayfa}/>
   < AuthRoute exact path="/register"  component={Uyeol}/>
    ...
    <Route exact path="/id/:userHandle/:ikonId/:bankabilgi" component={User}/>
    <Route exact path="/id/:screamid" component={userTwo}/>
    <Route exact path="/id/:screamid/login" component={GirisyapUrlTanim}/>
